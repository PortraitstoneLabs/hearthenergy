...
const YouTubeVideo = () => {
  ...
  const videoIds = ['x89QnZw-q1g', 'zolJAJqhEvk'];
  ...
  return (
    ...
    </div><div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%', maxWidth: '100%', overflow: 'hidden' }}>
        ...
        <div style={{ width: '100%', maxWidth: '560px', marginBottom: '20px' }}>
          <div className="video-wrapper">
            <iframe
              ...
              width="100%"
              height="315"
              src={`https://www.youtube-nocookie.com/embed/${videoIds[1]}`} // First video ID
              frameBorder="0"
              allowFullScreen
            ></iframe>
          </div>
